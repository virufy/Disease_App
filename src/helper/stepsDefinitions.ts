const baseUrl = '/disease-app/submit-steps';
const welcomeUrl = '/disease-app/welcome';
  ...
  return [
    {
      ...
      props: {
        storeKey,
        previousStep: '/disease-app/welcome/step-4',
  ...
  return [
    ...
    },
    {
      ...
      props: {
        ...
        nextStep: '/disease-app/submit-steps/step-record/cough',
